...
Технологический уровень цивилизации Xha'Ruun можно охарактеризовать как **~0.78 по шкале Кардашёва** — они находятся на стадии перехода от планетарной к звёздной цивилизации. Они овладели термоядерным синтезом, построили орбитальный лифт, колонизировали ближайшие тела Солнечной системы — но всё ещё depend on своей родной планеты для большинства ресурсов.
...
> | Солнечная энергия | 3 200 | 20% | Дополнительный |
...
> **КЛЮЧЕВОЙ ФАКТ**
>
> Управляемый термоядерный синтез был впервые продемонстрирован в **+1 420 г. цив.** — спустя 940 лет после основания Совета Единства. По земным меркам это примерно 1960-е годы по уровню науки, но потребовалось на 400 лет больше из-за более медленного восстановления после Эпохи Кризиса.

**Типы реакторов:**

| Тип | Топливо | T плазмы | Статус | Применение |
|-----|---------|---------|--------|------------|
| **Токамак (Thar-Vek)** | D + T (³H) | 150 млн K | Промышленный (+1 420) | Стационарные станции |
| **Стелларатор (Khel-Thar)** | D + ³He | 200 млн K | Промышленный (+2 100) | Компактные реакторы |
| **Лазерный синтез (Khar-Thar)** | D + D | 300 млн K | Экспериментальный | Перспективный |
...
*Рис. 9.1. Схема термоядерного реактора типа «токамак» (Thar-Vek). Магнитное удержание плазмы (D+T) при 150 млн K. Стрелками показан поток энергии к бланкету.*

**Топливная база:**
- **Дейтерий:** в изобилии (→ см. [Гл.01, «Нуклеосинтез»]) — концентрация в 3.2× выше земной
...
### 9.1.3 Солнечная энергетика

Из-за более низкой инсоляции (→ см. [Гл.02, «Khar'Vex»]) солнечные панели на Théxar занимают бо́льшие площади, чем земные аналоги. Однако высокая эффективность хромофилловых фотоэлементов (→ см. [Гл.04, «Фотосинтез»]) частично компенсирует это.
...
|---------|---|-----------|-------------------|----------|------------|
| **Кхарний (Kh)** | 127 | 327 | **12 400 лет** | Ферромагнетик, высокая T_c | Сверхпроводники |
| **Вексаний (Vx)** | 128 | 330 | 8 200 лет | Высокая плотность (24 г/см³) | Балласт, защита |
| **Тхарий (Thr)** | 129 | 333 | 3 500 лет | Тугоплавкий (T_пл = 4 200 K) | Термоядерные реакторы |
| **Нурий (Nur)** | 130 | 336 | 1 800 лет | Каталитическая активность | Химическая промышленность |
...
- **Троса орбитального лифта** — углеродные нанотрубки + кхарниевая легировка (прочность на разрыв: 120 ГПа)
...
|-----|----------|---------|--------|
| Маглев (междугородный) | до 600 км/ч | Электричество | Повсеместно |
| Маглев (высокоскоростной) | до 1 200 км/ч | Сверхпроводники | Основные магистрали |
| Электрический личный | до 180 км/ч | Электричество | Города |
| Грузовой | до 120 км/ч | Электричество | Сеть |

### 9.3.2 Авиация

Авиация использует электродвигатели и (на военных/исследовательских аппаратах) водородные турбины. Пассажирские перевозки — на высотах 8–14 км, скорость до 900 км/ч. Сверхзвуковая авиация существует, но ограничена (шумовые ограничения).
...
> | Прочность троса | 120 ГПа |
> | Грузоподъёмность | 120 т/рейс |
> | Скорость подъёма | 200 км/ч |
> | Время в пути | ~8 суток (до GSO) |
...
| Компонент | Описание |
|-----------|----------|
| **Якорь** (поверхность) | Шестиугольная платформа 1.2 × 1.2 км, на высоте 2 400 м над уровнем моря (экваториальная зона) |
| **Трос** | Пучок углеродных нанотрубок, легированных кхарнием. Диаметр: 12 см у основания, 0.5 см на орбитальном конце |
| **Кабины** | Электромагнитные подъёмники, 4 кабины (2 поднимаются, 2 опускаются одновременно) |
| **Противовес** | GSO-станция «GSO-1» (расширенная, масса ~4 200 т) |
| **Энергия** | Солнечные панели на тросе + лазерная передача энергии с поверхности |

**Экономика лифта:**
- Стоимость доставки груза на орбиту: ∼200 VT/кг (против ∼12 000 VT/кг ракетой)
- Окупаемость: достигнута за 80 лет
- Пассажиропоток: ∼5 000 человек/год (специалисты, туристы)
- Грузопоток: ∼2 400 т/год (материалы для станций, космические аппараты)
...
*Рис. 9.2. Схема орбитального лифта Кхар-Тор. Длина: 38 200 км. Материал троса: углеродные нанотрубки + кхарний.*
...
После ввода всех трёх лифтов грузопоток в космос достигнет 10 000 т/год — что откроет возможность строительства орбитального города.
...
> | Параметр | Значение |
> |----------|----------|
> | Цель | Ближайшая звезда (5.2 св. лет) |
> | Тип двигателя | Фотонный парус + лазерный разгон |
> | Максимальная скорость | 0.08 c (24 000 км/с) |
> | Время полёта | ~65 лет |
> | Старт | +3 800 г. цив. |
...
|---------|---------------|
| **Двигатель** | Фотонный парус (площадь: 1 000 м²) + лазерный разгон с орбиты Théxar (мощность: 100 ГВт, длительность: 20 мин) |
| **Корпус** | Кремний-органический композит, толщина 2 мм. Защита: вексаниевая фольга (0.1 мм) от космической пыли |
| **Энергия** | РИТЭГ на основе кха́рния (период полураспада 12 400 лет) + солнечные панели |
| **Связь** | Лазерный канал (100 Мбит/с на дистанции до 1 св. года, 10 Мбит/с на дистанции 5 св. лет) |
| **Задержка сигнала** | ~5.2 года в одну сторону (на максимальной дистанции) |
...
3. Передача данных — ожидается ∼3 ТБ научной информации в течение 10 лет активной фазы
4. После завершения миссии — зонд продолжит движение к следующей звезде (0.03 св. года за 1 000 лет)

> **КЛЮЧЕВОЙ ФАКТ**
>
> Зонд «Нур-Векс» движется настолько быстро (0.08 c), что долетит до ближайшей звезды за ~65 лет. Но из-за замедления времени (специальная теория относительности) на зонде пройдёт на 0.2 года меньше, чем на Théxar. Для Xha'Ruun это первый эксперимент с релятивистскими эффектами на межзвёздных расстояниях.

### 9.6.3 Космическая инфраструктура

| Объект | Орбита | Статус | Функция |
|--------|--------|--------|---------|
| Станция «Кхар-Векс» | НОО (400 км) | Активна (+520) | Научная, пересадочная |
| Станция «GSO-1» | GSO (38 200 км) | Активна (+2 150) | Торговая, грузовая |
...
|-----------|-------|-----------------|
| Наземные телескопы (14) | Всё небо | Объекты >50 м |
| Космический телескоп «Тхар-Вен» | Точка L2 | Объекты >10 м |
| Орбитальный радар (экватор) | Внутренняя система | Объекты >5 м |

### 9.7.2 Система отклонения

При обнаружении опасного объекта (вероятность столкновения >1%), применяются следующие методы:
1. **Малые объекты (<100 м):** лазерное испарение поверхности (абляция)
2. **Средние объекты (100–500 м):** кинетический ударник (масса 10–20 т)
3. **Крупные объекты (>500 м):** термоядерный заряд (отклонение)

> **КЛЮЧЕВОЙ ФАКТ**
>
> За последние 3 000 лет система планетарной защиты перехватила 11 потенциально опасных объектов (из них 3 — >500 м). Технология термоядерного отклонения была применена 1 раз (+2 110 г.) против астероида диаметром 1.8 км.
...
> **КЛЮЧЕВОЙ ФАКТ**
>
> Xha'Ruun не вели крупных войн вот уже **2 780 лет** (с Договора Единства, −750 г. цив.). Вооружённые силы существуют исключительно для обороны и поддержания порядка. Военная технология — не главный приоритет.
...
- **Лесопосадки** (+12% лесного покрова за последние 500 лет)
...
1. **Энергетика:** термояд (62%) — доминирующий источник, дейтерия в 3.2× больше земного
2. **Ключевые материалы:** сверхтяжёлые элементы (Z=126–130) — кхарний, вексаний, тхарий, нурий
3. **Орбитальный лифт:** 38 200 км, грузоподъёмность 120 т/рейс
...
6. **Планетарная защита:** 11 перехваченных объектов за 3 000 лет
7. **ИИ:** существует, но без самосознания (этический запрет)
8. **Войн нет:** 2 780 лет мира
...
- 2 780 лет без крупных войн — ЗАФИКСИРОВАНО
